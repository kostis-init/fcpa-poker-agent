...
from nn_actions import apply_nn


class FcpaPolicy(policy.Policy):

    def __init__(self, game, player_ids, nn_model, models_confidence_level):
        self.nn_model = nn_model
        self.game = game
        self.player_ids = player_ids
        self.models_confidence_level = models_confidence_level
    ...
    def action_probabilities(self, state, player_id=None):
      ...
      Returns:
        ...
        supplied state.
      """
        actions_floats = apply_nn(self.nn_model, state.information_state_string(), self.models_confidence_level)
